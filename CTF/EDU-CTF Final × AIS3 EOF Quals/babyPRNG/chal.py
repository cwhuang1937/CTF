...
# print(f'res: {ciphertext.hex()}')
# print(f'ans: {flag_ciper}')

flag_ciper = '9dfa2c9ccd5c84c61feb00ea835e848732ac8701da32b5865a84db59b08532b6cf32ebc10384c45903bf860084d018b5d55a5cebd832ef8059ead810'
flag = bytes.fromhex(flag_ciper)
flag = bytes([x ^ y for x, y in zip(flag, random_sequence)])
print(flag)
